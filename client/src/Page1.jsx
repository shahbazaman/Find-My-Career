...
import {
  ...
  FaUserTie, FaCogs, FaBullhorn, FaStethoscope
} from "react-icons/fa";
...
export default function JobSearchPage() {
  ...
  /* ── Fetch real job categories (by jobTitle count) ── */
  useEffect(() => {
  ...
  /* ── Fallback dummy categories (shown while loading) ── */
  ...
  /* ── Build looped companies list for scroll animation ── */
