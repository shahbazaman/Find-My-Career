...
function CustomDatePicker({ value, onChange, name }) {
  ...
  return (
    <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
      {/* Month */}
      <select value={month} onChange={handleMonth} style={selectStyle}>
      ...
      {/* Day */}
      <select value={day} onChange={handleDay} style={{ ...selectStyle, maxWidth: "80px" }}>
      ...
      {/* Year */}
      <select value={year} onChange={handleYear} style={{ ...selectStyle, maxWidth: "100px" }}>
