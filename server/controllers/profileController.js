...
export const clearResumeController = async (req, res) => {
  try {
    const { userId } = req.params;
    
    // Find profile and set resumeUrl to empty string
    ...
    res.status(200).json({ message: "Resume cleared successfully", profile: updatedProfile });
  } catch (error) {
